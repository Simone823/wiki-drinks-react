...
export const valueCards = [
  {
    title: "Educare",
    icon: <IoSchool className="icon card-icon text-2xl" />,
    text:
      " Pickled hashtag portland pork belly cred selvage viral retro prism lomo narwhal cray selfies vegan lyft.",
  },
  {
    title: "Insegnare",
    icon: <IoPeopleCircleSharp className="icon card-icon text-2xl" />,
    text:
  ...
  {
    title: "Centralizzare",
    icon: <ImDatabase className="icon card-icon text-2xl" />,
    text:
